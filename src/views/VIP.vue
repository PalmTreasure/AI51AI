  ...
  data() {
    return {
      ...
      plans: [
        ...
        { level: 5, name: "VIP 5", price: 200, tasks: 1, daily: 6.50, durationSeconds: 365 * 86400 },
        { level: 6, name: "VIP 6", price: 300, tasks: 1, daily: 10, durationSeconds: 365 * 86400 },
        { level: 7, name: "VIP 7", price: 900, tasks: 1, daily: 33, durationSeconds: 365 * 86400 },
        { level: 8, name: "VIP 8", price: 1350, tasks: 1, daily: 51, durationSeconds: 365 * 86400 },
        { level: 9, name: "VIP 9", price: 1800, tasks: 1, daily: 70, durationSeconds: 365 * 86400 },
        { level: 10, name: "VIP 10", price: 3600, tasks: 1, daily: 150, durationSeconds: 365 * 86400 },
        { level: 11, name: "VIP 11", price: 7200, tasks: 1, daily: 330, durationSeconds: 365 * 86400 },
        { level: 12, name: "VIP 12", price: 14400, tasks: 1, daily: 700, durationSeconds: 365 * 86400 },
        { level: 13, name: "VIP 13", price: 18800, tasks: 1, daily: 1600, durationSeconds: 365 * 86400 },
        { level: 14, name: "VIP 14", price: 37600, tasks: 1, daily: 3500, durationSeconds: 365 * 86400 },
        { level: 15, name: "VIP 15", price: 75200, tasks: 1, daily: 7500, durationSeconds: 365 * 86400 },
        { level: 16, name: "VIP 16", price: 150400, tasks: 1, daily: 16000, durationSeconds: 365 * 86400 },
      ],
